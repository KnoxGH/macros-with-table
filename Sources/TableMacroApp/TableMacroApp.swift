...
final class TableMacroAppDelegate: NSObject, NSApplicationDelegate {
...
@main
struct TableMacroApp: App {
    @NSApplicationDelegateAdaptor(TableMacroAppDelegate.self) private var appDelegate
    @StateObject private var model = AppModel()

    var body: some Scene {
        Window("TableMacro", id: "main") {
