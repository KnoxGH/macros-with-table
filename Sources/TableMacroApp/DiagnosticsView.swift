...
struct DiagnosticsView: View {
        ...
        VStack(alignment: .leading, spacing: 18) {
            ...
            Form {
                Section("Microphone") {
                    ...
                    Label(
                        "TableMacro uses only the channels exposed by AVAudioEngine; physical microphone-array access is not assumed.",
    ...
    private func hardwareIssueDescription(_ issue: AudioHardwarePolicyIssue) -> String {
        ...
        case .builtInInputRequired(let selected):
            return "\(selected) is selected. TableMacro requires the built-in microphone."
