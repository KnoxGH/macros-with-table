...
enum LocalActionDispatchError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .pasteboardWriteFailed:
            return "TableMacro could not write the assigned text to the pasteboard."
...
final class DebugRecordingStore {
    ...
    init(fileManager: FileManager = .default) throws {
        ...
        directory = support.appendingPathComponent("TableMacro/DebugCaptures", isDirectory: true)
