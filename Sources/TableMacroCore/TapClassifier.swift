...
/// The trained per-desk model: a robust normalization, a feature-weighted
/// nearest-example distance per zone (backed by novelty/negative rejection),
/// and an optional regularized linear boundary layered on top for stability.
