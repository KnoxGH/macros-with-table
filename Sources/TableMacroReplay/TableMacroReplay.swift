import Darwin
import Foundation
import TableMacroReplaySupport
...
@main
enum TableMacroReplayMain {
    private static let usage = """
    Usage: TableMacroReplay --profile <profile.json> --evaluation <evaluation.json> [--wav-dir <dir>] [--mode vectors|wav] [--json]
    """
    ...
    static func main() {
        ...
        do {
            ...
            let message = "TableMacroReplay: \(error.localizedDescription)\n\(usage)\n"
